// Login page: lets the user sign in with email + password, or use the demo account, and redirects to the search page after a successful login.
...
const LOGIN_MESSAGES = [
  ...
  // Synchronous lock that prevents duplicate submissions even if state updates haven't rendered yet (e.g. double-click before the re-render).
  ...
  useEffect(() => {
    if (isLight) return;
    let active = true;
    const currentPhrase = typingPhrases[phraseIndex], words = currentPhrase.split(' ');
    ...
    words.forEach((_, i) => {
      timers.push(setTimeout(() => {
        if (active) setVisibleWords(i + 1);
      }, (i + 1) * WORD_DELAY));
    });

    const totalTyping = words.length * WORD_DELAY;
    timers.push(setTimeout(() => {
      if (active) setFadePhase('out');
    }, totalTyping + HOLD_DURATION));
    timers.push(setTimeout(() => {
      if (active) setPhraseIndex((prev) => (prev + 1) % typingPhrases.length);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        hideLoader();
        toast({ kind: 'error', code: 400, title: 'Login Failed', message: res.message || 'Invalid credentials.' });
      }
    } catch (err: unknown) {
      hideLoader();

      const { message, title, code } = err instanceof ApiError
        ? {
            message: err.message,
            title: err.status === 0 ? 'Network Error' : err.status === 408 ? 'Request Timed Out' : err.status === 401 || err.status === 403 ? 'Unauthorized' : 'Server Error',
            code: err.status === 0 ? 0 : err.status === 401 || err.status === 403 ? err.status : 500,
          }
        : {
      ...
      toast({ kind: 'error', code, title, message });
    } finally {
  ...
  // ------------------------------------------
  const goldenDots = [
    { left: '14%', bottom: '32%', size: 2, delay: '0s', dur: '2.2s' }, { left: '16%', bottom: '34%', size: 2, delay: '0.3s', dur: '2.5s' },
    { left: '13%', bottom: '33%', size: 2, delay: '0.6s', dur: '2.3s' }, { left: '18%', bottom: '32%', size: 2, delay: '0.9s', dur: '2.7s' },
    { left: '15%', bottom: '35%', size: 2, delay: '1.2s', dur: '2.1s' }, { left: '17%', bottom: '31%', size: 2, delay: '0.2s', dur: '2.6s' },
    { left: '12%', bottom: '34%', size: 2, delay: '1.5s', dur: '2.4s' }, { left: '19%', bottom: '33%', size: 2, delay: '0.4s', dur: '2.8s' },
    { left: '20%', bottom: '35%', size: 2, delay: '0.7s', dur: '2.2s' }, { left: '11%', bottom: '32%', size: 2, delay: '1.1s', dur: '2.5s' },
    { left: '29%', bottom: '24%', size: 2, delay: '0.8s', dur: '2.4s' }, { left: '30%', bottom: '22%', size: 2, delay: '0.1s', dur: '2.7s' },
    { left: '28%', bottom: '23%', size: 2, delay: '1.4s', dur: '2.3s' }, { left: '31%', bottom: '25%', size: 2, delay: '0.5s', dur: '2.6s' },
    { left: '27%', bottom: '21%', size: 2, delay: '1.0s', dur: '2.2s' }, { left: '32%', bottom: '23%', size: 2, delay: '0.3s', dur: '2.5s' },
    { left: '41%', bottom: '32%', size: 2, delay: '0.2s', dur: '2.3s' }, { left: '43%', bottom: '31%', size: 2, delay: '0.6s', dur: '2.6s' },
    { left: '40%', bottom: '33%', size: 2, delay: '1.1s', dur: '2.4s' }, { left: '44%', bottom: '32%', size: 2, delay: '0.4s', dur: '2.7s' },
    { left: '42%', bottom: '30%', size: 2, delay: '0.8s', dur: '2.2s' }, { left: '45%', bottom: '33%', size: 2, delay: '1.3s', dur: '2.5s' },
    { left: '39%', bottom: '31%', size: 2, delay: '0.7s', dur: '2.8s' }, { left: '44%', bottom: '34%', size: 2, delay: '1.0s', dur: '2.3s' },
    { left: '43%', bottom: '25%', size: 2, delay: '0.5s', dur: '2.5s' }, { left: '44%', bottom: '23%', size: 2, delay: '0.9s', dur: '2.3s' },
    { left: '42%', bottom: '24%', size: 2, delay: '1.3s', dur: '2.6s' }, { left: '45%', bottom: '22%', size: 2, delay: '0.2s', dur: '2.4s' },
    { left: '41%', bottom: '26%', size: 2, delay: '0.7s', dur: '2.2s' }, { left: '48%', bottom: '28%', size: 2, delay: '0.4s', dur: '2.7s' },
    { left: '49%', bottom: '27%', size: 2, delay: '1.2s', dur: '2.3s' }, { left: '47%', bottom: '29%', size: 2, delay: '0.8s', dur: '2.5s' },
    { left: '54%', bottom: '24%', size: 2, delay: '0.1s', dur: '2.4s' }, { left: '55%', bottom: '22%', size: 2, delay: '1.5s', dur: '2.6s' },
    { left: '53%', bottom: '23%', size: 2, delay: '0.6s', dur: '2.3s' }, { left: '56%', bottom: '21%', size: 2, delay: '1.1s', dur: '2.5s' },
    { left: '52%', bottom: '25%', size: 2, delay: '0.3s', dur: '2.7s' }, { left: '61%', bottom: '28%', size: 2, delay: '0.5s', dur: '2.2s' },
    { left: '63%', bottom: '27%', size: 2, delay: '0.9s', dur: '2.6s' }, { left: '60%', bottom: '29%', size: 2, delay: '1.3s', dur: '2.4s' },
    { left: '64%', bottom: '28%', size: 2, delay: '0.2s', dur: '2.7s' }, { left: '62%', bottom: '26%', size: 2, delay: '0.7s', dur: '2.3s' },
    { left: '65%', bottom: '29%', size: 2, delay: '1.0s', dur: '2.5s' }, { left: '59%', bottom: '27%', size: 2, delay: '0.4s', dur: '2.8s' },
    { left: '66%', bottom: '28%', size: 2, delay: '1.4s', dur: '2.2s' }, { left: '67%', bottom: '24%', size: 2, delay: '0.3s', dur: '2.5s' },
    { left: '68%', bottom: '23%', size: 2, delay: '1.6s', dur: '2.7s' }, { left: '66%', bottom: '25%', size: 2, delay: '0.8s', dur: '2.3s' },
    { left: '71%', bottom: '21%', size: 2, delay: '0.4s', dur: '2.6s' }, { left: '72%', bottom: '20%', size: 2, delay: '1.0s', dur: '2.4s' },
    { left: '70%', bottom: '22%', size: 2, delay: '1.5s', dur: '2.2s' }, { left: '22%', bottom: '36%', size: 2, delay: '0.5s', dur: '2.5s' },
    { left: '35%', bottom: '27%', size: 2, delay: '1.3s', dur: '2.8s' }, { left: '48%', bottom: '30%', size: 2, delay: '0.8s', dur: '2.3s' },
    { left: '53%', bottom: '26%', size: 2, delay: '0.2s', dur: '2.6s' }, { left: '59%', bottom: '25%', size: 2, delay: '1.5s', dur: '2.4s' },
    { left: '38%', bottom: '26%', size: 2, delay: '0.9s', dur: '2.7s' }, { left: '46%', bottom: '27%', size: 2, delay: '1.7s', dur: '2.2s' },
  ];
  ...
  return (
    <>
      <style>{`
        ...
        .input-golden-wrapper{position:relative;border-radius:10px;padding:1.5px;overflow:hidden;background:rgba(80,130,200,.18);transition:box-shadow .3s ease}
        .input-golden-wrapper:focus-within{background:rgba(80,150,240,.35);box-shadow:0 0 0 3px rgba(50,120,220,.1)}
        .input-golden-inner{position:relative;z-index:1;display:flex;align-items:center;height:40px;background:#0c1630;border-radius:9px;padding:0 14px}
        .light-theme .input-golden-inner{background:#f1f5f9}
        .light-theme .input-golden-wrapper{background:rgba(37,99,235,.10);border:1px solid rgba(0,0,0,.1)}
        .card-golden-wrapper{position:relative;border-radius:18px;padding:1.5px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.4),0 0 6px rgba(218,165,32,.30),0 0 16px rgba(218,165,32,.16),0 0 32px rgba(218,165,32,.06)}
        ...
        .card-golden-inner{position:relative;z-index:1;border-radius:17px;background:rgba(10,20,45,.95);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);box-shadow:inset 0 0 6px rgba(218,165,32,.20),inset 0 0 14px rgba(218,165,32,.10)}
        .light-theme .card-golden-inner{background:rgba(255,255,255,.97);box-shadow:inset 0 0 6px rgba(218,165,32,.10),inset 0 0 14px rgba(218,165,32,.05)}
        .light-theme .card-golden-wrapper{box-shadow:0 20px 60px rgba(0,0,0,.10),0 0 6px rgba(218,165,32,.20),0 0 16px rgba(218,165,32,.10)}
        ...
        @media (prefers-reduced-motion:reduce){.card-golden-wrapper::before{animation:none}.earth-dot{animation:none;opacity:.5}}
      `}</style>
      ...
      <div className={`relative flex flex-col lg:flex-row h-auto min-h-screen lg:h-screen w-full overflow-y-auto lg:overflow-hidden font-[Segoe_UI,Roboto,Helvetica_Neue,Arial,sans-serif] ${isLight ? 'bg-transparent' : 'bg-[#060d1a]'}`}>
        ...
        {/* BACKGROUND IMAGES */}
        {/* -------------------------------- */}
        <img src={bg2} alt="" className={`pointer-events-none fixed inset-0 z-0 h-[100dvh] min-h-full w-full object-cover object-center lg:object-left ${isLight ? 'hidden' : ''}`} />
        ...
        {/* GOLDEN DOTS */}
        {/* -------------------------------- */}
        {!isLight && <div className="pointer-events-none absolute inset-0 z-[3]">{goldenDots.map((d, i) => <div key={i} className="earth-dot" style={{ left: d.left, bottom: d.bottom, width: `${d.size}px`, height: `${d.size}px`, background: 'radial-gradient(circle, rgba(255,223,100,1) 0%, rgba(255,200,50,0.9) 25%, rgba(255,180,0,0.5) 55%, transparent 80%)', boxShadow: `0 0 ${d.size + 2}px rgba(255,223,100,0.9), 0 0 ${d.size + 6}px rgba(255,200,50,0.6), 0 0 ${d.size + 10}px rgba(255,180,0,0.3)`, '--delay': d.delay, '--dur': d.dur } as React.CSSProperties} />)}</div>}
        ...
        <div className="relative z-[5] flex min-h-[auto] lg:min-h-screen flex-1 flex-col px-6 lg:px-[50px] pb-10 lg:pb-[50px] pt-8 lg:pt-10">
          ...
          <div className="relative z-10 flex flex-col items-start">
            ...
            <p className={`m-0 mt-1 text-[10px] font-semibold tracking-[5px] uppercase ${isLight ? 'text-[#64748b]' : 'text-[rgba(200,215,235,0.65)]'}`}>AKBAR BIZVOY</p>
          </div>
          ...
          <div className={`relative z-10 max-w-[520px] pl-2 ${isLight ? 'flex-1 flex flex-col justify-end pb-18' : 'mt-6'}`}>
            ...
            {isLight ? (
              /* LIGHT THEME TAGLINE */
              <h2 className="m-0 text-[28px] lg:text-[40px] font-bold leading-[1.2] text-[#1e293b]">
                {taglineWords.map((word, i) => {
                  const isBlue = word === 'Seamless';
                  return <span key={i}><span style={{ opacity: fadePhase === 'out' ? 0 : i < visibleWords ? 1 : 0, transition: `opacity ${fadePhase === 'out' ? 0.5 : 0.3}s ease-in-out`, color: isBlue ? '#2563eb' : undefined }}>{word}</span>{word === 'Seamless' && <br />}{i < taglineWords.length - 1 && word !== 'Seamless' && ' '}</span>;
                })}
              </h2>
            ) : (
              /* DARK THEME TAGLINE */
              <div className="relative z-10 mt-4 max-w-[500px]">
                <div className="flex flex-wrap items-center" style={{ minHeight: '50px' }}>
                  {typingPhrases[phraseIndex].split(' ').map((word, i) => {
                    const isVisible = i < visibleWords, isBlue = word.endsWith('.');
                    return <span key={`${phraseIndex}-${i}`} className="text-[24px] lg:text-[36px] font-bold leading-[1.15]" style={{ color: isBlue ? '#3b9cff' : '#ffffff', opacity: fadePhase === 'out' ? 0 : isVisible ? 1 : 0, transition: `opacity ${fadePhase === 'out' ? FADE_OUT_DURATION : 300}ms ease-in-out`, marginRight: '10px' }}>{word}</span>;
                  })}
                </div>

                {/* Brand Lines */}
                <div className="mt-[14px] flex items-center gap-[3px]">
                  <span className="h-[3px] w-9 rounded-full bg-[#00AEEF] lg:w-10" /><span className="h-[3px] w-9 rounded-full bg-[#8CC63F] lg:w-10" /><span className="h-[3px] w-9 rounded-full bg-[#F5821F] lg:w-10" /><span className="h-[3px] w-9 rounded-full bg-[#E4007F] lg:w-10" />
                </div>
          ...
          <div className="relative z-10 flex flex-wrap gap-4 lg:gap-9 pb-2 mt-2">
            {[
              ...
              { icon: <><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></>, title: 'Seamless', sub: 'Journeys', bgColor: isLight ? 'bg-[#e0edff]' : 'bg-[rgba(50,120,220,0.15)]', iconColor: isLight ? 'text-[#2563eb]' : 'text-[#4aa3ff]' },
              { icon: <><path d="M3 18v-6a9 9 0 0 1 18 0v6" /><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z" /></>, title: '24/7', sub: 'Support', bgColor: isLight ? 'bg-[#e0edff]' : 'bg-[rgba(50,120,220,0.15)]', iconColor: isLight ? 'text-[#2563eb]' : 'text-[#4aa3ff]' },
            ].map((f, i) => (
            ...
            <div className="card-golden-inner px-5 lg:px-8 py-[22px] pb-[18px] text-center">
              ...
              <div className="mb-3 flex justify-center">
                <div className="relative flex h-[85px] w-[85px] items-center justify-center">
                  ...
                  <img src={logo} alt="Akbar Bizvoy Logo" className="h-[70px] w-auto" />
                </div>
              </div>

              {/* Brand name */}
              <p className={`m-0 mb-1 text-center text-[13px] font-semibold tracking-[6px] uppercase ${isLight ? 'text-[#64748b]' : 'text-[rgba(200,215,235,0.65)]'}`}>AKBAR BIZVOY</p>
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3 text-left">
                    ...
                    <div className="input-golden-inner relative">
                      ...
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className={`absolute right-3 top-1/2 flex -translate-y-1/2 cursor-pointer items-center justify-center border-none bg-transparent p-1 transition-colors duration-200 ${isLight ? 'text-[#94a3b8] hover:text-[#475569]' : 'text-[rgba(140,170,210,0.45)] hover:text-[rgba(170,200,240,0.8)]'}`} aria-label={showPassword ? 'Hide password' : 'Show password'}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-[18px] w-[18px]">
                          {showPassword ? <><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></> : <><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" /><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19" /><path d="m14.12 14.12-4.24-4.24" /><path d="M9.88 9.88a3 3 0 0 0 4.24 4.24" /><line x1="1" y1="1" x2="23" y2="23" /></>}
                        </svg>
                      </button>
                    </div>
                  </div>
                ...
                {/* SIGN IN */}
                <button type="submit" disabled={isSubmitting} className="mt-0.5 flex w-full cursor-pointer items-center justify-center gap-2 rounded-[10px] border-none bg-gradient-to-br from-[#1565e0] via-[#1d7bf5] to-[#2b8df8] py-[11px] text-[15px] font-semibold tracking-[0.3px] font-inherit text-white shadow-[0_4px_20px_rgba(25,100,230,0.3),0_1px_3px_rgba(25,100,230,0.2)] transition-all duration-250 hover:-translate-y-px hover:from-[#1d75f0] hover:via-[#2588ff] hover:to-[#3598ff] hover:shadow-[0_6px_28px_rgba(25,100,230,0.4),0_2px_6px_rgba(25,100,230,0.25)] active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 disabled:hover:from-[#1565e0] disabled:hover:via-[#1d7bf5] disabled:hover:to-[#2b8df8] disabled:hover:shadow-[0_4px_20px_rgba(25,100,230,0.3),0_1px_3px_rgba(25,100,230,0.2)]">
                ...
                <button type="button" onClick={() => {
                  ...
                  <span className={`text-[11.5px] ${isLight ? 'text-[#475569]' : 'text-white/70'}`}>demo@akbarbizvoy.com / demo123</span>
                </button>

                {/* CREATE ACCOUNT */}
                <p className={`m-0 mt-1.5 text-center text-[13px] ${isLight ? 'text-[#64748b]' : 'text-[rgba(170,195,225,0.5)]'}`}>
                  Don't have an account?{' '}
                  <a href="#" onClick={(e) => { e.preventDefault(); navigate('/register'); }} className={`font-semibold no-underline transition-colors duration-200 hover:underline ${isLight ? 'text-[#2563eb] hover:text-[#1d4ed8]' : 'text-[#3b9cff] hover:text-[#6bb3ff]'}`}>Create account</a>
                </p>
              </form>
            </div>
          </div>

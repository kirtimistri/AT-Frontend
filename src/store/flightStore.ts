...
const onwardFlights: Flight[] = [
  {
    ...
    airline: 'INDIGO',
    code: '6E 6602',
    departure: { time: '10:30 AM', airport: 'PNQ Terminal 1' },
    arrival: { time: '1:55 PM', airport: 'DEL Terminal 2' },
    via: 'via NAG',
    duration: '3h 25m',
    stops: '1 Stop',
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 247',
    departure: { time: '9:40 AM', airport: 'PNQ Terminal 2' },
    arrival: { time: '11:45 AM', airport: 'DEL Terminal 3' },
    duration: '2h 5m',
    stops: 'Non-stop',
  ...
  },
  {
    ...
    airline: 'AKASA',
    code: 'QP 1385',
    departure: { time: '7:55 AM', airport: 'PNQ Terminal 1' },
  ...
  },
  {
    ...
    airline: 'SPICEJET',
    code: 'SG 815',
    departure: { time: '11:20 AM', airport: 'PNQ Terminal 1' },
    arrival: { time: '1:40 PM', airport: 'DEL Terminal 1' },
    duration: '2h 20m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 4980,
  ...
  },
  {
    ...
    airline: 'SPICEJET',
    code: 'SG 819',
    departure: { time: '6:05 AM', airport: 'PNQ Terminal 1' },
    arrival: { time: '8:25 AM', airport: 'DEL Terminal 1' },
    duration: '2h 20m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 4210,
  ...
  },
  {
    ...
    airline: 'AKASA',
    code: 'QP 1373',
    departure: { time: '2:15 PM', airport: 'PNQ Terminal 1' },
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 610',
    departure: { time: '5:30 AM', airport: 'PNQ Terminal 2' },
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6214',
    departure: { time: '11:25 PM', airport: 'PNQ Terminal 1' },
    arrival: { time: '1:35 AM', airport: 'DEL Terminal 2' },
    duration: '2h 10m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 5120,
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6573',
    departure: { time: '3:10 PM', airport: 'PNQ Terminal 1' },
    arrival: { time: '9:15 PM', airport: 'DEL Terminal 2' },
    via: 'via HYD, IDR',
    duration: '6h 5m',
    stops: '2 Stops',
    baggage: '15 kg baggage',
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 854',
    departure: { time: '8:50 AM', airport: 'PNQ Terminal 2' },
    arrival: { time: '12:30 PM', airport: 'DEL Terminal 3' },
    via: 'via NAG',
    duration: '3h 40m',
    stops: '1 Stop',
    baggage: '25 kg baggage',
  ...
  },
  {
    ...
    airline: 'SPICEJET',
    code: 'SG 947',
    departure: { time: '9:35 AM', airport: 'PNQ Terminal 1' },
    arrival: { time: '3:25 PM', airport: 'DEL Terminal 1' },
    via: 'via NAG, JAI',
    duration: '5h 50m',
    stops: '2 Stops',
    baggage: '15 kg baggage',
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6329',
    departure: { time: '5:45 AM', airport: 'PNQ Terminal 1' },
    arrival: { time: '1:25 PM', airport: 'DEL Terminal 2' },
    via: 'via NAG, IDR, JAI',
    duration: '7h 40m',
    stops: '3 Stops',
    baggage: '15 kg baggage',
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6608',
    departure: { time: '6:40 PM', airport: 'PNQ Terminal 1' },
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 953',
    departure: { time: '7:20 AM', airport: 'PNQ Terminal 2' },
...
const returnFlightData: Flight[] = [
  {
    ...
    airline: 'SPICEJET',
    code: 'SG 836',
    departure: { time: '6:00 AM', airport: 'DEL Terminal 1' },
    arrival: { time: '8:20 AM', airport: 'PNQ Terminal 1' },
    duration: '2h 20m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 4480,
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6213',
    departure: { time: '5:30 AM', airport: 'DEL Terminal 2' },
    arrival: { time: '7:40 AM', airport: 'PNQ Terminal 1' },
    duration: '2h 10m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 5120,
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 2440',
    departure: { time: '8:15 AM', airport: 'DEL Terminal 3' },
    arrival: { time: '10:20 AM', airport: 'PNQ Terminal 2' },
    duration: '2h 5m',
    stops: 'Non-stop',
    baggage: '25 kg baggage',
    price: 6250,
  ...
  },
  {
    ...
    airline: 'AKASA',
    code: 'QP 1368',
    departure: { time: '4:35 PM', airport: 'DEL Terminal 1' },
    arrival: { time: '6:55 PM', airport: 'PNQ Terminal 1' },
    duration: '2h 20m',
    stops: 'Non-stop',
    baggage: '20 kg baggage',
    price: 5980,
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6444',
    departure: { time: '11:20 PM', airport: 'DEL Terminal 2' },
    arrival: { time: '1:30 AM', airport: 'PNQ Terminal 1' },
    duration: '2h 10m',
    stops: 'Non-stop',
    baggage: '15 kg baggage',
    price: 4980,
  ...
  },
  {
    ...
    airline: 'SPICEJET',
    code: 'SG 930',
    departure: { time: '2:45 PM', airport: 'DEL Terminal 1' },
    arrival: { time: '8:50 PM', airport: 'PNQ Terminal 1' },
    via: 'via JAI, IDR',
    duration: '6h 5m',
    stops: '2 Stops',
    baggage: '15 kg baggage',
  ...
  },
  {
    ...
    airline: 'INDIGO',
    code: '6E 6531',
    departure: { time: '10:10 AM', airport: 'DEL Terminal 2' },
    arrival: { time: '5:05 PM', airport: 'PNQ Terminal 1' },
    via: 'via JAI, IDR, HYD',
    duration: '6h 55m',
    stops: '3 Stops',
    baggage: '20 kg baggage',
  ...
  },
  {
    ...
    airline: 'AIR INDIA',
    code: 'AI 875',
    departure: { time: '5:55 PM', airport: 'DEL Terminal 3' },
    arrival: { time: '12:50 AM', airport: 'PNQ Terminal 1' },
    via: 'via NAG, HYD',
    duration: '6h 55m',
    stops: '2 Stops',
    baggage: '25 kg baggage',

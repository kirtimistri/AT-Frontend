// TravellerInformation – Displays the traveller's personal details (name, gender, contact) for the booking review page.
...
export const TravellerInformation = () => {
  ...
  return (
    <div className={`rounded-lg border p-6 lg:p-7 transition-colors duration-300 ${isLight ? 'border-[#EEEEEE] bg-white' : 'border-[#29466e] bg-[#0f172a]'}`}>
      {/* Section header with icon, title, and booker info */}
